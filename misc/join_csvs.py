...
#    Updated: 2019/07/01 20:55:33 by tholzheu         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print("Incorrect number of arguments. Must have 3. (3rd is name of person)")
        exit(1);
    ...
    name = "datasets/full_data/data_{}_{}_{}.csv".format(len(combined_df), time.time(), sys.argv[3])
